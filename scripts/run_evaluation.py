...
def load_queries(dataset_path: str) -> list[tuple[str, str]]:
    ...
    for line in path.read_text(encoding="utf-8").splitlines():
        ...
        rows.append((item["query"], item["expected"]))
    return rows
...
def main() -> None:
    ...
    parser.add_argument("--dataset", type=str, default="data/eval_dataset.jsonl")
